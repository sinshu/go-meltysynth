...
func checkPresetRegion(t *testing.T, region *meltysynth.PresetRegion, values []float64) {
	...
	areEqual(t, float64(meltysynth.GetPresetModulationLfoToPitch(region)), values[0])
	areEqual(t, float64(meltysynth.GetPresetVibratoLfoToPitch(region)), values[1])
	areEqual(t, float64(meltysynth.GetPresetModulationEnvelopeToPitch(region)), values[2])
	areEqual(t, float64(meltysynth.GetPresetInitialFilterCutoffFrequency(region)), values[3])
	areEqual(t, float64(meltysynth.GetPresetInitialFilterQ(region)), values[4])
	areEqual(t, float64(meltysynth.GetPresetModulationLfoToFilterCutoffFrequency(region)), values[5])
	areEqual(t, float64(meltysynth.GetPresetModulationEnvelopeToFilterCutoffFrequency(region)), values[6])
	areEqual(t, float64(meltysynth.GetPresetModulationLfoToVolume(region)), values[7])
	areEqual(t, float64(meltysynth.GetPresetChorusEffectsSend(region)), values[8])
	areEqual(t, float64(meltysynth.GetPresetReverbEffectsSend(region)), values[9])
	areEqual(t, float64(meltysynth.GetPresetPan(region)), values[10])
	areEqual(t, float64(meltysynth.GetPresetDelayModulationLfo(region)), values[11])
	areEqual(t, float64(meltysynth.GetPresetFrequencyModulationLfo(region)), values[12])
	areEqual(t, float64(meltysynth.GetPresetDelayVibratoLfo(region)), values[13])
	areEqual(t, float64(meltysynth.GetPresetFrequencyVibratoLfo(region)), values[14])
	areEqual(t, float64(meltysynth.GetPresetDelayModulationEnvelope(region)), values[15])
	areEqual(t, float64(meltysynth.GetPresetAttackModulationEnvelope(region)), values[16])
	areEqual(t, float64(meltysynth.GetPresetHoldModulationEnvelope(region)), values[17])
	areEqual(t, float64(meltysynth.GetPresetDecayModulationEnvelope(region)), values[18])
	areEqual(t, float64(meltysynth.GetPresetSustainModulationEnvelope(region)), values[19])
	areEqual(t, float64(meltysynth.GetPresetReleaseModulationEnvelope(region)), values[20])
	areEqual(t, float64(meltysynth.GetPresetKeyNumberToModulationEnvelopeHold(region)), values[21])
	areEqual(t, float64(meltysynth.GetPresetKeyNumberToModulationEnvelopeDecay(region)), values[22])
	areEqual(t, float64(meltysynth.GetPresetDelayVolumeEnvelope(region)), values[23])
	areEqual(t, float64(meltysynth.GetPresetAttackVolumeEnvelope(region)), values[24])
	areEqual(t, float64(meltysynth.GetPresetHoldVolumeEnvelope(region)), values[25])
	areEqual(t, float64(meltysynth.GetPresetDecayVolumeEnvelope(region)), values[26])
	areEqual(t, float64(meltysynth.GetPresetSustainVolumeEnvelope(region)), values[27])
	areEqual(t, float64(meltysynth.GetPresetReleaseVolumeEnvelope(region)), values[28])
	areEqual(t, float64(meltysynth.GetPresetKeyNumberToVolumeEnvelopeHold(region)), values[29])
	areEqual(t, float64(meltysynth.GetPresetKeyNumberToVolumeEnvelopeDecay(region)), values[30])
	areEqual(t, float64(meltysynth.GetPresetKeyRangeStart(region)), values[31])
	areEqual(t, float64(meltysynth.GetPresetKeyRangeEnd(region)), values[32])
	areEqual(t, float64(meltysynth.GetPresetVelocityRangeStart(region)), values[33])
	areEqual(t, float64(meltysynth.GetPresetVelocityRangeEnd(region)), values[34])
	areEqual(t, float64(meltysynth.GetPresetInitialAttenuation(region)), values[35])
	areEqual(t, float64(meltysynth.GetPresetCoarseTune(region)), values[36])
	areEqual(t, float64(meltysynth.GetPresetFineTune(region)), values[37])
	areEqual(t, float64(meltysynth.GetPresetScaleTuning(region)), values[38])
}
